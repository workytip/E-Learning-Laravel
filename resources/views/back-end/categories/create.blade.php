...
@section('content')
    ...
    @component('back-end.layout.header',['mynav' => 'Adding Category'])
    @endcomponent
...
<div class="content">
    ...
    <div class="container-fluid ">
        ...
        <p class="card-category text-warning">You can Add Category here </p>
        <div class="row ">
            ...
            <div class="col-md-8 ">
                <div class="card ">
                    ...
                    <div class="card-header">
                        <h4 class="card-title text-info">Add New Category</h4>
                    </div>
